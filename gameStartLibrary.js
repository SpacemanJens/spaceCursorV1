...
class DecorativeOrangeStar extends DecorativeBasicStar {
    constructor(x, y) {
        super(x, y);
...
class Spejder {
    ...
    loadAnimationFrames() {
        ...
        for (let i = 1; i <= 24; i++) {
            ...
            this.framesLeft.push(loadImage(`gameSetupImages/p4spejder/${frameName}.png`));
        }

        // Load right-facing frames
        for (let i = 1; i <= 24; i++) {
            const frameName = `p4spejderR${i}`;
            this.framesRight.push(loadImage(`gameSetupImages/p4spejder/${frameName}.png`));
        }
    }
...
class ImageIndex8Manager {
    ...
    loadImages() {
        ...
        for (let i = 1; i <= 6; i++) {
            ...
            this.warpgateAImages.push(loadImage(`gameSetupImages/p3warpgateA/${frameName}.png`));
        }

        // Load warpgate B images
        for (let i = 1; i <= 13; i++) {
            const frameName = `p3warpgateB${i}`;
            this.warpgateBImages.push(loadImage(`gameSetupImages/p3warpgateB/${frameName}.png`));
        }
    }
...
class ImageIndex11Manager {
    ...
    loadImages() {
        ...
        for (let i = 1; i <= 13; i++) {
            ...
            this.warpgateImages.push(loadImage(`gameSetupImages/p4warpgateA/${frameName}.png`));
        }

        // Load lightTower images
        for (let i = 1; i <= 11; i++) {
            const frameName = `p4lightTower${i}`;
            this.lightTowerImages.push(loadImage(`gameSetupImages/p4lightTower/${frameName}.png`));
        }
    }
...
class ImageIndex13Manager {
    ...
    loadImages() {
        ...
        this.jellyfishImages.push(loadImage("gameSetupImages/p4p3jellyfish/p4p3jellyfishLeft.png"));
        this.jellyfishImages.push(loadImage("gameSetupImages/p4p3jellyfish/p4p3jellyfishLowerLeft.png"));
        this.jellyfishImages.push(loadImage("gameSetupImages/p4p3jellyfish/p4p3jellyfishLowerMiddle.png"));
        this.jellyfishImages.push(loadImage("gameSetupImages/p4p3jellyfish/p4p3jellyfishLowerRight.png"));
        this.jellyfishImages.push(loadImage("gameSetupImages/p4p3jellyfish/p4p3jellyfishUpperLeft.png"));
        this.jellyfishImages.push(loadImage("gameSetupImages/p4p3jellyfish/p4p3jellyfishUpperRight.png"));
...
class ImageIndex16Manager {
    ...
    loadImages() {
        ...
        for (let i = 1; i <= 10; i++) {
            ...
            this.warpgateImages.push(loadImage(`gameSetupImages/p0warpgateA/${frameName}.png`));
        }

        // Load warpgate images
        for (let i = 1; i <= 6; i++) {
            const frameName = `p0water${i}`;
            this.waterImages.push(loadImage(`gameSetupImages/p0water/${frameName}.png`));
        }
...
class ImageIndex10Manager {
    ...
    loadImagesAndAddSpacecrafts() {
        ...
        this.backgroundImage = loadImage("gameSetupImages/hangerTeamBlueEffect/hangerTeamBlueEmpty1.png");

        // Load spacecraft images and create spacecraft objects
        const blackCircleImg = loadImage("gameSetupImages/hangerTeamBlueEffect/blackCircleDownLeft1.png");
        const upperLeftImg = loadImage("gameSetupImages/hangerTeamBlueEffect/spaceCraftUpperLeft.png");
        const upperRightImg = loadImage("gameSetupImages/hangerTeamBlueEffect/spaceCraftUpperRight.png");
        const lowerLeftImg = loadImage("gameSetupImages/hangerTeamBlueEffect/spaceCraftLowerLeft.png");
        const lowerRightImg = loadImage("gameSetupImages/hangerTeamBlueEffect/spaceCraftLowerRight.png");
...
class SpacecraftManager {
    ...
    loadImages() {
        this.images = [];
        for (let i = 1; i <= 20; i++) {
            this.images.push(loadImage(`gameSetupImages/spacecraftIcons/spacecraft${i}.png`));
        }
    }
...
class GameImageManager {
    ...
    loadImages() {
        const imagePaths = [
            "gameSetupImages/largeImages/hangerTeamGreen.png", "gameSetupImages/largeImages/planet1p1.png", "gameSetupImages/largeImages/planet1p2.png",
            "gameSetupImages/largeImages/planet1p3.png", "gameSetupImages/largeImages/planet2p1.png", "gameSetupImages/largeImages/planet2p2.png",
            "gameSetupImages/largeImages/planet3p1.png", "gameSetupImages/largeImages/planet3p2.png", "gameSetupImages/largeImages/planet3p3.png",
            "gameSetupImages/largeImages/planet3p4.png", "gameSetupImages/largeImages/hangerTeamBlue.png", "gameSetupImages/largeImages/planet4p1.png",
            "gameSetupImages/largeImages/planet4p2.png", "gameSetupImages/largeImages/planet4p3cleaned.png", "gameSetupImages/largeImages/planet4p4.png",
            "gameSetupImages/largeImages/logo.png", "gameSetupImages/largeImages/planet0p1.png", "gameSetupImages/largeImages/planet0p2.png",
            "gameSetupImages/largeImages/planet0p3.png", "gameSetupImages/largeImages/planet0p4.png"
        ];
